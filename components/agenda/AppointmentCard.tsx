  ...
  return (
    <>
      <button
        ...
        className={cn(
          "w-full min-w-0 overflow-hidden flex items-center gap-3 rounded-lg border border-neutral-200 bg-white p-4 text-left transition-all hover:border-primary hover:shadow-sm",
          className,
        )}
      >
        <Avatar
          ...
          <div className="mt-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-neutral-600">
                  {formatCurrency(appointment.saldo)}
                </span>
              </div>
            </div>
