...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-neutral-200 bg-white transition-transform duration-300 ease-in-out",
              ...
              <Dialog open={logoutOpen} onOpenChange={setLogoutOpen}>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      ¿Estás seguro que deseas cerrar sesión? Deberás iniciar
                      sesión nuevamente.
                    </DialogDescription>
                  </DialogHeader>
                  <DialogFooter>
